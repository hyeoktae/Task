...
//        for i in stride(from: 4, to: 67, by: 3){} // 4부터 시작해서 4,7,10,13,16,19... by만큼 증가해서 ...64까지
//        for i in stride(from: 4, through: 67, by: 3){} // 4부터 시작해서 4,7,10,13,16,19... by만큼 증가해서 ...67까지
