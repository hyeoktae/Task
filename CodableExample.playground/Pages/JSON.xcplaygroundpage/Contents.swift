...
UserDefaults.standard.data(forKey: "myMacBook")

// JSON파일로 저장
let appSupportDir = FileManager.default.urls(
  for: .documentDirectory, in: .userDomainMask
  ).first!
//FileManager.default.url(for: <#T##FileManager.SearchPathDirectory#>, in: <#T##FileManager.SearchPathDomainMask#>, appropriateFor: <#T##URL?#>, create: <#T##Bool#>)
