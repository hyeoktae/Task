...
class ViewController: UIViewController {
    ...
    var songsChart: [String: [String: [String]]] = [:] {
        didSet {
            chartYears = (self.songsChart["Melon"]?.keys.sorted())!
    ...
    @IBAction private func printDocumentsDirectory(_ sender: UIButton) {
        ...
        let documentsUrl = FileManager.default.urls(
            ...
            in: .userDomainMask // iOS 에서는 거의 고정
            ).first! // 반드시 있기 때문에 강제 바인딩
        print(documentsUrl.path)
        
        
        
        //    let test = documentsUrl
        //        .appendingPathComponent("test")
        //        .appendingPathExtension("txt")
        //
        //    try? (["t":"est"] as NSDictionary).write(to: test)
    ...
    @IBAction private func bundleFile(_ sender: UIButton) {
        ...
        print(self.songsChart["Melon"]!["2017년"])
    ...
    private func saveFileUrl() -> URL {
        ...
        let saveDir = appSupportDir.appendingPathComponent(bundleIdentifier, isDirectory: true)
        ...
        let fileUrl = saveDir.appendingPathComponent("SongsChart")
    ...
    @IBAction private func loadFile(_ sender: UIButton) {
        ...
        let fileUrl = saveFileUrl()
        guard fileManager.fileExists(atPath: fileUrl.path) else { return print("File doesn't exist")}
